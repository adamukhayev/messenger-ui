  ...
  return (
      <div className='message-list-container'>
        <Toolbar
            ...
            rightItems={[
              <Icon icon={errorOutline} color="blue" width="30" height="30"
                    style={{marginLeft: 10}}/>,
              <Icon icon={videocamIcon} color="blue" width="30" height="30"
                    style={{marginLeft: 10}}/>,
              <Icon icon={callSharp} color="blue" width="30" height="30"
                    style={{marginLeft: 10}}/>
            ]}
        />
        ...
        <Compose rightItems={[
          <Icon icon={send28Filled} color="blue" width="25" height="25"
                style={{marginLeft: 10}}/>,
          <Icon icon={baselineAddAPhoto} color="blue" width="25" height="25"
                style={{marginLeft: 10}}/>,
          <Icon icon={imagePlus} color="blue" width="25" height="25"
                style={{marginLeft: 10}}/>,
          <Icon icon={microphoneAlt} color="blue" width="25" height="25"
                style={{marginLeft: 10}}/>,
          <Icon icon={emoji48Filled} color="blue" width="25" height="25"
                style={{marginLeft: 10}}/>
        ]}/>
      </div>
  );
